      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center space-x-3 space-x-reverse group">
            ...
            <div>
              <span className="text-3xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent moraba">
                ونتورا
              </span>
        ...
        <Card className="shadow-2xl border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl">
          <CardHeader className="text-center pb-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2">
              به خانواده بزرگ <span className='moraba'>ونتورا</span> خوش آمدید
            </p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              <Button
                ...
                variant="outline"
                className="w-full h-12 border border-gray-200 dark:border-gray-700 flex items-center justify-center gap-3 rounded-xl font-semibold text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-900 hover:bg-green-50 dark:hover:bg-gray-800 transition-all duration-200 shadow-sm hover:shadow-md"
              >
                <FaGoogle className="w-5 h-5 text-[#EA4335] ml-2" />
                <span className="flex-1 text-center">ورود با گوگل</span>
              </Button>
              
              <Button
                onClick={() => handleSocialLogin('github')}
                variant="outline"
                className="w-full h-12 border border-gray-200 dark:border-gray-700 flex items-center justify-center gap-3 rounded-xl font-semibold text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200 shadow-sm hover:shadow-md"
              >
                <FaGithub className="w-5 h-5 text-gray-800 dark:text-gray-200 ml-2" />
                <span className="flex-1 text-center">ورود با گیت‌هاب</span>
              </Button>
            </div>
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="bg-white dark:bg-gray-800 px-4 text-sm text-gray-500 dark:text-gray-400 flex items-center gap-2">
                  <span className="w-8 h-px bg-gray-200 dark:bg-gray-700 inline-block"></span>
                  یا
                  <span className="w-8 h-px bg-gray-200 dark:bg-gray-700 inline-block"></span>
                </span>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="h-12 pl-12 bg-white dark:bg-gray-900"
                  />
                  <button
                    type="button"
