        ...
        {loading ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8">
              {[...Array(4)].map((_, i) => (
                <motion.div
                  ...
                  className="rounded-3xl p-6 animate-pulse shadow-lg bg-white/30 dark:bg-gray-900/40 backdrop-blur-lg border border-white/30 dark:border-gray-700/40 inverted-radius"
                >
          ...
          >
            <div className="relative md:my-24">
              ...
              <div className="custom-swiper-pagination4 flex justify-center gap-1" />
            </div>
          </motion.div>
        )}
          ...
          >
            ...
            <div className="flex items-center justify-between flex-col md:flex-row gap-2 w-full">
              <div className='flex flex-col'>
                <span className="text-lg text-center sm:text-2xl font-bold bg-gradient-to-r from-emerald-600 via-teal-500 to-orange-400 bg-clip-text text-transparent mb-1 moraba">
                  همه محصولات ونتورا را کشف کنید!
                </span>
                <span className="text-gray-800 dark:text-gray-100 text-sm mb-2 text-center">
              ...
              >
                <span className="tracking-wide text-sm text-white dark:text-gray-900">مشاهده همه محصولات</span>
                <motion.svg
                  className="w-5 h-5 group-hover:translate-x-1 transition-transform !rotate-180 text-white dark:text-gray-900"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  initial={{ x: 0 }}
